...
# Sounds
death_sfx = pygame.mixer.Sound("assets/sfx/assets_sfx_lose.mp3")
points_sfx = pygame.mixer.Sound("assets/sfx/assets_sfx_100points.mp3")
jump_sfx = pygame.mixer.Sound("assets/sfx/assets_sfx_jump.mp3")
